...
import { Search, Tag, Trash2, ExternalLink, Filter } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

export default function WishlistPage() {
    const { wishlist, assignments, removeFromWishlist, assignItem } = useUserData();
    ...
    return (
        <div className="min-h-screen bg-zinc-950 pb-32 pt-6 px-4">
            <header className="mb-6">
                <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-brand to-purple-500">
                    Your Collection
                </h1>
