...
export const SwipeDeck = forwardRef<SwipeDeckRef, SwipeDeckProps>(({ products: initialProducts, onSwipeRight, onSwipeLeft, loading }, ref) => {
    ...
    if (loading) {
        return (
            <div className="relative w-full max-w-sm aspect-[3/5] animate-pulse">
    ...
    if (visibleProducts.length === 0) {
        return (
            <div className="relative w-full max-w-sm aspect-[3/5] flex flex-col items-center justify-center text-zinc-500 bg-zinc-900/50 rounded-3xl border-2 border-dashed border-zinc-800">
